...
namespace ConfigDataExpoter
{
    ...
    public interface IFormatter
    {
        ...
        /// <returns></returns>
        object SerializeDataTable(List<object> dataTable, Type classType);
        /// <summary>
        /// 反序列化
        /// </summary>
    ...
    public abstract class FormatterImpBase : IFormatter
    {
        ...
        public abstract object SerializeDataTable(List<object> dataTable, Type classType);
    }
    /// <summary>
    /// 字节流序列化反序列化实现
    /// </summary>
    public class BinaryFormatterImp : FormatterImpBase
    {
        ...
        public override object SerializeDataTable(List<object> dataTable, Type classType)
        {
    ...
    public class Formatter : IFormatter
    {
        ...
        public object SerializeDataTable(List<object> dataTable, Type classType)
        {
